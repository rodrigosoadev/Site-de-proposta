...
import { FileText, Mail, Check, Loader2 } from "lucide-react";
...
export default function Login() {
  ...
  const handlePasswordReset = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      setError(error.message || "Ocorreu um erro ao tentar enviar o e-mail de redefinição.");
    } finally {
      setIsSubmitting(false);
    }
  };
  ...
  return (
    <>
      <Head 
        title="Login" 
        description="Acesse sua conta do PropostaPro" 
        ogType="website"
      />
